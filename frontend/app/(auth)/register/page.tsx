...
export default function RegisterPage() {
  ...
  const { register: registerUserApi, error, fieldErrors, user } = useAuth()
        ...
        <Card className="w-full max-w-md glass-card shadow-xl rounded-2xl p-6 sm:p-10 flex flex-col gap-6 relative z-10 transition-all duration-300 hover:shadow-2xl ring-0">
          ...
          <CardContent className="p-0">
            <form id="register-form" onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
              ...
              <Field className="gap-1.5">
                <FieldLabel className="text-muted-foreground typo-label-md animate-fade-in" htmlFor="register-name">
                  {t('nameLabel')}
                </FieldLabel>
                <FieldContent>
              ...
              {/* Email */}
              <Field className="gap-1.5">
                <FieldLabel className="text-muted-foreground typo-label-md animate-fade-in" htmlFor="register-email">
                  {t('emailLabel')}
                </FieldLabel>
                <FieldContent>
                  <div className="relative group/input">
              ...
              {/* Password */}
              <Field className="gap-1.5">
                <FieldLabel className="text-muted-foreground typo-label-md animate-fade-in" htmlFor="register-password">
                  {t('passwordLabel')}
                </FieldLabel>
                <FieldContent>
                  <div className="relative group/input">
              ...
              {/* Confirm Password */}
              <Field className="gap-1.5">
                <FieldLabel className="text-muted-foreground typo-label-md animate-fade-in" htmlFor="register-confirm-password">
          ...
          <div className="pt-2 text-center border-t border-border/40">
            <p className="typo-caption text-muted-foreground">
              {t('haveAccount')}{' '}
              <Link href="/login" className="text-primary font-medium hover:text-primary-hover hover:underline transition-colors">
                {t('login')}
              </Link>
            </p>
          </div>
