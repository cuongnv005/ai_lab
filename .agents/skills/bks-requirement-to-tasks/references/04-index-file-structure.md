...
- **Phase 3 (Frontend)**: {status_icon} {completed}/{total}
...
The implementation is divided into {N} modules across {M} phases. Each module contains detailed tasks and dependencies.
...
| # | Task Module | Type | Effort | Link | Status |
| :--- | :--- | :--- | :--- | :--- | :--- |
| 5 | **{Title}** | IMPL | M | [Task 05]({relative-path}) | ⏳ Pending |
