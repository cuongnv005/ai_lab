...
Canonical Next.js list in this repo (target after applying this skill):

- `features/users/components/users-page-content.tsx`
- `features/users/components/users-filters-toolbar.tsx`
- `features/users/hooks/use-users.ts`
- `features/users/utils/users-list-query.ts` — parse/serialize (reference implementation)
