...
|-----------|--------------|-------------|
| **Command** | `app/Console/Commands/{Module}/{Name}Command.php` | `PascalCase`, must end with `Command` |
| **Signature** | Colon-separated | Lowercase (e.g., `system:cleanup`) |
| **Background Service** | `app/Services/Background/{Module}/{Feature}BackgroundService.php` | `PascalCase` |
| **Background DTO** | `app/DTOs/Background/{Module}/{Action}Data.php` | `PascalCase` + `Data` suffix |

**Example**:
```php
// Command
app/Console/Commands/System/CleanupCommand.php
signature: 'system:cleanup'

// Service
app/Services/Background/System/CleanupBackgroundService.php
