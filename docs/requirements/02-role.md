...
### 6.1. Spatie Permission Tables (tự động tạo bởi package migration)
...
## 8. UI/UX & FRONTEND IMPLICATIONS

### 8.1. API Response Changes
...
|---|---|---|---|
| "Cần thêm RBAC" | RBAC system | OVERVIEW, Section 5 | ✅ Covered |
| "sử dụng laravel permission package" | Spatie package | Section 6.1, Phase 1 Task 1 | ✅ Covered |
| "2 role admin và member" | Admin + Member roles | Section 6.3, Flow 1, Flow 5 | ✅ Covered |
