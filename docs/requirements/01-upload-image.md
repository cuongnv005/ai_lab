...
### 5.2 Thiết kế Thumb cho các màn hình
...
### 6.1 Table: `images` (Migration Modify)
...
### 6.2 Model: `Image` (`backend/app/Models/Image.php`)
...
### 6.3 Config: `config/upload.php` (Modify)
...
### 8.3 Zod Schema (nếu frontend có form upload)
