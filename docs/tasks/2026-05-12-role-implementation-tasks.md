...
|---|---|---|
| §5.1 Role Storage Strategy | — | Task 01 |
| §5.2 UserRole Enum | — | Task 01 |
| §5.3 Default Role Assignment | Flow 1 | Task 01 (seeder), Task 03 (register) |
| §5.4 First Admin | Flow 5 | Task 01 |
| §6 Data Model Updates | — | Task 01 (Spatie tables) |
