...
## 1. 🛠️ Danh Sách 20 AI Agent Skills

Hệ thống hiện có **20 skill chuyên biệt**, được chia thành các nhóm vai trò rõ ràng:
...
*   **`code-review`**: Đóng vai trò chuyên gia rà soát chất lượng mã nguồn, phát hiện lỗ hổng bảo mật, lỗi logic tiềm ẩn hoặc các điểm chưa tuân thủ quy chuẩn dự án trước khi tạo Pull Request.
...
3.  **Code Review**: Yêu cầu AI Agent sử dụng skill `code-review` để quét toàn bộ các file code đã sửa đổi, đánh giá xem có lỗ hổng bảo mật, lỗi N+1 Query DB hay vi phạm tiêu chuẩn thiết kế không.
...
3.  **Tạo Pull Request**: Developer đẩy code lên Git repository để tiến hành chạy CI/CD và review nội bộ trước khi merge vào nhánh chính.
